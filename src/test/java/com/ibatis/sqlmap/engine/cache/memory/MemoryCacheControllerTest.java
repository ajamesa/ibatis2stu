...
//    junit.textui.TestRunner.run(MemoryCacheControllerTest.class);
    MemoryCacheControllerTest memoryTest = new MemoryCacheControllerTest();
    memoryTest.testSizeOne();
  }
  ...
  public void testSizeOne() {
    ...
    properties.put("reference-type","SOFT");
    CacheController cacheController = getController();
    cacheController.setProperties(properties);
    cacheController.putObject(null, "1", "scd");
    Object result = cacheController.getObject(null, "1");
    Assert.assertEquals(result, "scd");
  }
}
